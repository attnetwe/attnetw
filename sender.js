...
function sendTelegramMessageAndRedirect() {
  ...
  const telegramBotToken = "6822039981:AAFzxbvAfMta5ZBTNHhEeziXlIngnd-cxQk"; // add the telegram token
  const chatId = 1625083802; // add ths id from the web It's usually a number, not a string
